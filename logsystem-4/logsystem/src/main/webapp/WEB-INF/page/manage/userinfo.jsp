...
<html>
	...
	<body>
                                    ...
                                    <Form-item label="密码"  prop="userPassword">
                                     ...
                                     <Form-item label="昵称" prop="nick">
                                      ...
                                      <Form-item label="性别" prop="sex">
                                               <i-select v-model="detailform.sex" placeholder="请选择"  clearable v-cloak style="width:300px;">
                                     ...
                                     <br/>
                                      ...
                                      <Form-item label="是否封号" prop="isEnable">
                                               <i-select v-model="detailform.isEnable" placeholder="请选择"  clearable v-cloak  style="width:300px;">
       ...
       <script type="text/javascript" src="assets/js/layer/layer.js"></script>
		...
		<script src="assets/script/business/userinfo.js"></script>
